...
if($accion=='modificar'){ 
                                        ...
                                        // Conectando, seleccionando la base de datos
                                            ...
                                            $query = "UPDATE contactos_externo SET Empresa='$empresa', Contacto='$referencia', Telefono='$telefono',id_ciudad='$id_ciudad',Correo='$correo' WHERE idcontactos_externo='$id'";
                        ...
                        if($accion=='Guardar'){ 
                                        ...
                                        // Conectando, seleccionando la base de datos
                                            ...
                                            // Realizar una consulta MySQL
                                            $query = "INSERT INTO contactos_externo (Empresa,Contacto,Telefono,id_ciudad,Correo) VALUES ('$empresa','$referencia','$telefono','$id_ciudad','$correo')";
                                            $result = mysql_query($query) or die('No fue posible actulizar los datos: ' . mysql_error());   
                         ...
                         if($accion=='Eliminar'){ 
                                        ...
                                        // Conectando, seleccionando la base de datos
                                            ...
                                            // Realizar una consulta MySQL
                                            $query = "DELETE FROM contactos_externo WHERE idcontactos_externo='$id'";
                                            $result = mysql_query($query) or die('No fue posible actulizar los datos: ' . mysql_error());   
...
<head>
    ...
    <title>Contactos - Empresas</title>
...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Contacto de Empresas y Otros</h1>  
                </div>
                <!-- /.col-lg-12 -->
            </div>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                       <form action="contactos_externo.php" method="POST">                              
                                    ...
                                    <div class="form-group">
                                        <label for="cargo">Referencia:</label>
                                       ...
                                       <select id="id_ciudad" name="id_ciudad" class="form-control" required="true"  >
                                        <?php 
                                            ...
                                            while ($line1 = mysql_fetch_array($result, MYSQL_ASSOC)) {
                                                    ...
                                                    echo '<option class="form-control" value='.$line1['ID'].'>'.$line1['Name'].' </option>';
                                            }
                                    ...
                                    <?php
                                       ...
                                       //$tildes = $link->query("SET NAMES 'utf8'"); //Para que se muestren las tildes
                                        ...
                                        // Conectando, seleccionando la base de datos
											...
											// Realizar una consulta MySQL
											$query = 'SELECT *,city.Name as ciudad FROM contactos_externo,city where contactos_externo.id_ciudad=city.ID';
											$result = mysql_query($query) or die('Consulta fallida: ' . mysql_error());
											...
											while ($line = mysql_fetch_array($result, MYSQL_ASSOC)) {
													...
													echo '<tr class="odd gradeX">';
                                       				echo "<td>".$line['idcontactos_externo']. "</td>";
                                        			...
                                        			echo "<td>".$line['Correo']."</td>" ;
                                        			  ...
                                        			  echo "<td><a data-toggle='modal' data-target='#editUsu' data-id='" .$line['idcontactos_externo'] ."' data-empresa='" . ($line['Empresa']) ."' data-referencia='" .$line['Contacto'] ."' data-telefono='" .$line['Telefono'] ."' data-idciudad='" .$line['id_ciudad'] ."' data-correo='" .$line['Correo'] ."' class='btn btn-warning btn-sm'><span class='glyphicon glyphicon-pencil'></span> Editar</a><a data-toggle='modal' data-target='#eliminar' data-id='" .$line['idcontactos_externo'] ."' data-empresa='" .($line['Empresa']) ."' data-referencia='" .$line['Contacto'] ."' data-telefono='" .$line['Telefono'] ."' data-idciudad='" .$line['id_ciudad'] ."' data-correo='" .$line['Correo'] ."' class='btn btn-danger btn-sm'><span class='glyphicon glyphicon-trash'></span> Eliminar</a></td> ";
