			...
			//$sql = $mysqli->query("insert into tbcontactos (nombre, edad, direccion) values ('$nom', $edad, '$dir') ");		
  			...
  			if($accion=='guardarnuevo'){
                                        ...
                                        // Conectando, seleccionando la base de datos
											...
											$query = "INSERT INTO contacto_nueva_esperanza (Nombres, Cargo,Celular,Skype,Correo) values ('$nombres','$cargo','$celular','$skype','$correo')";
				...
				if($accion=='modificar'){							// Conectando, seleccionando la base de datos
											...
											// Realizar una consulta MySQL
											$query = "UPDATE contacto_nueva_esperanza SET nombres='$nombres', cargo='$cargo', celular='$celular',skype='$skype',correo='$correo' WHERE id_nuevaesperanza='$id'";
										...
										if($accion=='eliminar'){							// Conectando, seleccionando la base de datos
											...
											// Realizar una consulta MySQL
											$query = "DELETE FROM contacto_nueva_esperanza WHERE  id_nuevaesperanza='$id'";
											$result = mysql_query($query) or die('No fue posible actulizar los datos: ' . mysql_error());	
...
<head>
    ...
    <title>Contactos - Nueva Esperanza </title>
        ...
        <div id="page-wrapper">
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <h1 class="page-header">Contactos Nueva Esperanza  </h1>
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                           Contactos Suc. Nueva Esperanza - Novara
                        </div>
                        <!-- /.panel-heading -->
                                       ...
                                       //$tildes = $link->query("SET NAMES 'utf8'"); //Para que se muestren las tildes
                                        ...
                                        // Conectando, seleccionando la base de datos
											...
											while ($line = mysql_fetch_array($result, MYSQL_ASSOC)) {
                                                    ...
                                                    echo "<td>".$line['id_nuevaesperanza']. "</td>";
                                                    ...
                                                    echo "<td>".$line['correo']."</td>" ;
                                                      echo "<td><a data-toggle='modal' data-target='#editUsu' data-id='" .$line['id_nuevaesperanza'] ."' data-nombre='" .utf8_encode($line['nombres']) ."' data-cargo='" .$line['cargo'] ."' data-celular='" .$line['celular'] ."' data-skype='" .$line['skype'] ."' data-correo='" .$line['correo'] ."' class='btn btn-primary btn-sm'><span class='glyphicon glyphicon-pencil'></span> Editar</a>
                                                      <a data-toggle='modal' data-target='#eliminar' data-id='" .$line['id_nuevaesperanza'] ."' data-nombre='" .utf8_encode($line['nombres']) ."' data-cargo='" .$line['cargo'] ."' data-celular='" .$line['celular'] ."' data-skype='" .$line['skype'] ."' data-correo='" .$line['correo'] ."' class='btn btn-warning btn-sm'><span class='glyphicon glyphicon-trash'></span> Eliminar</a></td> ";	
                                                    echo "</tr>";
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                       <form action="contactos_nueva_esperanza.php" method="POST">              		
