...
if($accion=='modificar'){                           // Conectando, seleccionando la base de datos
                                            ...
                                            // Realizar una consulta MySQL
                                            $query = "UPDATE contacto_administrativo_novara SET nombres='$nombres', celular='$celular', cargo='$cargo',skype='$skype',correo='$correo' WHERE id_administrativo='$id'";
                                        ...
                                        if($accion=='eliminar'){                            // Conectando, seleccionando la base de datos
                                            ...
                                            // Realizar una consulta MySQL
                                            $query = "DELETE FROM contacto_administrativo_novara WHERE  id_administrativo='$id'";
                                            $result = mysql_query($query) or die('No fue posible actulizar los datos: ' . mysql_error());   
...
<head>
    ...
    <title>Contactos - Administrativo</title>
...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Contacto Administrativo</h1>  
                </div>
                <!-- /.col-lg-12 -->
            </div>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                       <form action="insertar_admnovara.php" method="GET">              		
          ...
          <div class="modal" id="editUsu" tabindex="-1" role="dialog" aria-labellebdy="myModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">                      
                       <form action="actualiza_admnovara.php" method="POST">                       		
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                           Contactos Administrativo Novara
                                       ...
                                       //$tildes = $link->query("SET NAMES 'utf8'"); //Para que se muestren las tildes
                                        ...
                                        // Conectando, seleccionando la base de datos
											...
											while ($line = mysql_fetch_array($result, MYSQL_ASSOC)) {
													...
													echo '<tr class="odd gradeX">';
                                       				echo "<td>".$line['id_administrativo']. "</td>";
                                        			echo "<td>".utf8_encode($line['Nombres'])."</td>";
                                        			echo "<td>".utf8_encode($line['Cargo'])."</td>" ;
                                        			 echo "<td> <a href='tel:+".$line['Celular'].">'</a>".$line['Celular']."</td>";
                                        			echo "<td>".$line['Skype']."</td>" ;
                                        			echo "<td>".$line['Correo']."</td>" ;
                                        			  ...
                                        			  echo "<td><a data-toggle='modal' data-target='#editUsu' data-id='" .$line['id_administrativo'] ."' data-nombre='" .utf8_encode($line['Nombres']) ."' data-cargo='" .$line['Cargo'] ."' data-celular='" .$line['Celular'] ."' data-skype='" .$line['Skype'] ."' data-correo='" .$line['Correo'] ."' class='btn btn-default btn-sm'><span class='glyphicon glyphicon-pencil'></span>Editar</a>
                                                      <a data-toggle='modal' data-target='#eliminar' data-id='" .$line['id_administrativo'] ."' data-nombre='" .utf8_encode($line['Nombres']) ."' data-celular='" .$line['celular'] ."' data-cargo='" .$line['cargo'] ."' data-correo='" .$line['correo'] ."' data-skype='" .$line['skype'] ."' class='btn btn-warning btn-sm'><span class='glyphicon glyphicon-trash'></span> Eliminar</a>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">                      
                       <form action="contactos_administrativo_novara.php" method="POST">                              
