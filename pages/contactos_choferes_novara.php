...
if($accion=='guardarnuevo'){
                                        ...
                                        // Conectando, seleccionando la base de datos
											...
											$query = "INSERT INTO contacto_choferes_novara (nombres, celular,matricula,direccion,ubicacion) values ('$nombres','$celular','$matricula','$direccion','$ubicacion')";
...
if($accion=='modificar'){							// Conectando, seleccionando la base de datos
											...
											// Realizar una consulta MySQL
											$query = "UPDATE contacto_choferes_novara SET nombres='$nombres', celular='$celular', matricula='$matricula',direccion='$direccion',ubicacion='$ubicacion' WHERE id_choferes='$id'";
										...
										if($accion=='eliminar'){							// Conectando, seleccionando la base de datos
											...
											// Realizar una consulta MySQL
											$query = "DELETE FROM contacto_choferes_novara WHERE  id_choferes='$id'";
											$result = mysql_query($query) or die('No fue posible actulizar los datos: ' . mysql_error());	
...
<head>
    ...
    <title>Contactos - Choferes</title>
...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Contacto Choferes</h1>
                                        ...
                                        // Conectando, seleccionando la base de datos
											...
											while ($line = mysql_fetch_array($result, MYSQL_ASSOC)) {
													...
													echo '<tr class="odd gradeX">';
                                       				echo "<td>".$line['id_choferes']. "</td>";
                                        			echo "<td>".utf8_encode($line['nombres'])."</td>";
                                        			//echo "<td>".utf8_encode($line[''])."</td>" ;
                                        			//echo "<td><a href=tel:+".$line['celular']."</a></td>" ;
                                                    echo "<td> <a href='tel:+".$line['celular'].">'</a>".$line['celular']."</td>";
                                                        echo "<td>".utf8_encode($line['direccion'])."</td>";
                                        			echo "<td>".utf8_encode($line['matricula'])."</td>" ;
                                        			echo "<td>".utf8_encode($line['ubicacion'])."</td>" ;
                                        			  echo "<td><a data-toggle='modal' data-target='#editUsu' data-id='" .$line['id_choferes'] ."' data-nombre='" .utf8_encode($line['nombres']) ."' data-celular='" .utf8_encode($line['celular']) ."' data-direccion='" .$line['direccion'] ."' data-matricula='" .$line['matricula'] ."' data-ubicacion='" .$line['ubicacion'] ."' class='btn btn-primary btn-sm'><span class='glyphicon glyphicon-pencil'></span> Editar</a>
                                                      <a data-toggle='modal' data-target='#eliminar' data-id='" .$line['id_choferes'] ."' data-nombre='" .utf8_encode($line['nombres']) ."' data-celular='" .$line['celular'] ."' data-direccion='" .$line['direccion'] ."' data-matricula='" .$line['matricula'] ."' data-ubicacion='" .$line['ubicacion'] ."' class='btn btn-warning btn-sm'><span class='glyphicon glyphicon-trash'></span> Eliminar</a></td> ";	
                                    				echo "</tr>";
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                       <form action="contactos_choferes_novara.php" method="POST">              		
                       		...
                       		<div class="form-group">
                       			<label for="celular">Matricula:</label>
                       			<input class="form-control" id="matricula" name="matricula" type="text" placeholder="Matricula: AAX-111"></input>
                       		</div>
                       		<div class="form-group">
                       			<label for="skype">Direccion:</label>
                       			<input class="form-control" id="direccion" name="direccion" type="text" placeholder="Av. Camilo Recalde"></input>
                       		</div>
                       		<div class="form-group">
                       			<label for="correo">Ubicacion:</label>
                       			<input class="form-control" id="ubicacion" name="ubicacion" type="text" placeholder="Ubicacion"></input>
                       		</div>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">                      
                       <form action="contactos_choferes_novara.php" method="POST">                       		
		                       		...
		                       		<div class="form-group">
		                       			<label for="celular">Matricula:</label>
		                       			<input class="form-control" id="matricula" name="matricula" type="text" ></input>
		                       		</div>
		                       		<div class="form-group">
		                       			<label for="skype">Direccion:</label>
    ...
    <script>	
		  ...
		  var recipient5 = button.data('ubicacion')
		  ...
		  modal.find('.modal-body #matricula').val(recipient3)		 
		   modal.find('.modal-body #direccion').val(recipient4)	
		    modal.find('.modal-body #ubicacion').val(recipient5)	
		});
