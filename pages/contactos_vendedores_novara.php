			...
			//$sql = $mysqli->query("insert into tbcontactos (nombre, edad, direccion) values ('$nom', $edad, '$dir') ");		
  			...
  			if($accion=='guardarnuevo'){
                                        ...
                                        // Conectando, seleccionando la base de datos
											...
											$query = "INSERT INTO contacto_vendedores_novara (Nombres, cargo,celular,skype,correo) values ('$nombres','$cargo','$celular','$skype','$correo')";
				...
				if($accion=='modificar'){							// Conectando, seleccionando la base de datos
											...
											// Realizar una consulta MySQL
											$query = "UPDATE contacto_vendedores_novara SET nombres='$nombres', cargo='$cargo', celular='$celular',skype='$skype',correo='$correo' WHERE id_vendedores='$id'";
										...
										if($accion=='eliminar'){							// Conectando, seleccionando la base de datos
											...
											// Realizar una consulta MySQL
											$query = "DELETE FROM contacto_vendedores_novara WHERE  id_vendedores='$id'";
											$result = mysql_query($query) or die('No fue posible actulizar los datos: ' . mysql_error());	
...
<head>
    ...
    <title>Contactos - Vendedores</title>
...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Contacto Vendedores</h1>
                                    ...
                                    <?php
                                       ...
                                       //$tildes = $link->query("SET NAMES 'utf8'"); //Para que se muestren las tildes
                                        ...
                                        // Conectando, seleccionando la base de datos
											...
											// Realizar una consulta MySQL
											$query = 'SELECT * FROM contacto_vendedores_novara';
											...
											while ($line = mysql_fetch_array($result, MYSQL_ASSOC)) {
                                        			...
                                        			echo "<td>".$line['correo']."</td>" ;
                                        			  echo "<td><a data-toggle='modal' data-target='#editUsu' data-id='" .$line['id_vendedores'] ."' data-nombre='" .utf8_encode($line['Nombres']) ."' data-cargo='" .utf8_encode($line['cargo']) ."' data-celular='" .$line['celular'] ."' data-skype='" .$line['skype'] ."' data-correo='" .$line['correo'] ."' class='btn btn-primary btn-sm'><span class='glyphicon glyphicon-pencil'></span> Editar</a>
                                                      <a data-toggle='modal' data-target='#eliminar' data-id='" .$line['id_vendedores'] ."' data-nombre='" .utf8_encode($line['Nombres']) ."' data-cargo='" .$line['cargo'] ."' data-celular='" .$line['celular'] ."' data-skype='" .$line['skype'] ."' data-correo='" .$line['correo'] ."' class='btn btn-warning btn-sm'><span class='glyphicon glyphicon-trash'></span> Eliminar</a></td> ";	
                                    				echo "</tr>";
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                       <form action="contactos_vendedores_novara.php" method="POST">              		
                       		...
                       		<div class="form-group">
                       			...
                       			<input class="form-control" id="skype" name="skype" type="text" placeholder="Skype"></input>
                       		</div>
                       		<div class="form-group">
                       			<label for="correo">Correo:</label>
                       			<input class="form-control" id="correo" name="correo" type="text" placeholder="Email"></input>
                       		</div>
...
<script>	
		  ...
		  var recipient2 = button.data('cargo')
		  var recipient3 = button.data('celular')
		  ...
		  modal.find('.modal-body #cargo').val(recipient2)
		  modal.find('.modal-body #celular').val(recipient3)		 
